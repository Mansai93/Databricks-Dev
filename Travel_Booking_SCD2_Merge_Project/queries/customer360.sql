...
CREATE OR REPLACE VIEW `dbx-external-catalog`.analytics.customer_360 AS
SELECT
...
FROM `dbx-external-catalog`.default.customer_dim d
JOIN `dbx-external-catalog`.default.booking_fact f
